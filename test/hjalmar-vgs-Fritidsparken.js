...
tap.equal(isTbr(options), true, 'hjalmar-vgs-Fritidsparken returns ture from 2830 Ulefoss')
...
tap.equal(isTbr(options), true, 'hjalmar-vgs-Fritidsparken returns true from 3805 Seljord')

options.postnummer = 3841
tap.equal(isTbr(options), true, 'hjalmar-vgs-Fritidsparken returns true from 3805 Flatdal')
...
tap.equal(isTbr(options), true, 'hjalmar-vgs-Fritidsparken returns true from 3702 Skien')
